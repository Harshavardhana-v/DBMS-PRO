...
const WaterAnimals = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/animals/water')
      .then((response) => {
        setAnimals(response.data);
      })
      .catch((error) => {
        console.error('Error fetching water animals:', error);
      });
  }, []);
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="mb-6">
        <input
          ...
          placeholder="Search for a water animal..."
          value={searchTerm}
      ...
      <h2 className="text-3xl font-semibold text-blue-800 mb-6">Water Animals Records</h2>
